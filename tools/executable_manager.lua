...
--[[
    ...
    executable_manager is a tool for managing the executable preferences stored in the anselrc file.
    On startup the anselrc file is scanned and a widget is built for each executable path.  The user
    can select the executable from a drop down list and then modify the settings as desired.

    Any changes made using executable_manager won't be saved in the anselrc file until darktable exits, but
...
local ANSELRC = dt.configuration.config_dir .. PS .. "anselrc"


-- grep the executable_paths statements out of the anselrc file

local matches = grep(ANSELRC, "executable_paths")
